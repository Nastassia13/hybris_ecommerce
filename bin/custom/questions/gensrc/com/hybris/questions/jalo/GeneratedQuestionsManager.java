 ...
 * --- Generated at 21.07.2021 17:05:00                         ---
 * ----------------------------------------------------------------
 */
package com.hybris.questions.jalo;

import com.hybris.questions.constants.QuestionsConstants;
import com.hybris.questions.jalo.Question;
import com.hybris.questions.jalo.QuestionsCMSComponent;
...
public abstract class GeneratedQuestionsManager extends Extension
{
	...
	**/
	 ...
	 */
	public Collection<Question> getQuestions(final SessionContext ctx, final Product item)
	{
		return PRODUCT2QUESTIONQUESTIONSHANDLER.getValues( ctx, item );
	}
	 ...
	 * @return the questions
	 */
	public Collection<Question> getQuestions(final Product item)
	{
	 ...
	 */
	public void setQuestions(final SessionContext ctx, final Product item, final Collection<Question> value)
	{
	 ...
	 * @param value the questions
	 */
	public void setQuestions(final Product item, final Collection<Question> value)
	{
